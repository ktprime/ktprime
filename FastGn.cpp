...
typedef void (*sieve_func)(const uint64 , const uint64 , const int , const int , uint64 []);
...
static void doSieve2(uchar dstarray[][BUFFER_SIZE8], const uint64 start, const int sievesize)
{
