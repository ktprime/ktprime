...
static int initParam(const uint64 n)
{
...
#if TEST_BENCHMARK
	if (n > atoint64("e12", 1000000) && Config.Ptk == GP1N)
		n = 1000000000;
#endif
	...
	initStartp(wheel, KData.SqrtN + 10);
