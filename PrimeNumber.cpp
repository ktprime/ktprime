...
//	#define CMP_BSET(n, mask) *ps##n |= mask
...
#else
	while ((sieve_index1 & sieve_index2) >= 0x80000000) {
		SAFE_SET(1);
		SAFE_SET(2);
	}
...
{
	const uchar prime7[ ] = {7, 11, 13, 17, 19, 23, 29};
...
static void printInfo( )
{
	...
	"Copyright @ by Huang Yuanbing (2012 - 2016) bailuzhou@163.com\n"
