...
# define ERATMEDIUM      55 / 100 //0.2 - 1
...
//pi(2^32) = 203280221,
//pi(1e9) = 50847534,
static const uint SQRT_PRIMES = 203280221;
...
//	static Stock MemStock[STOCK_SIZE];
	...
	for (int i = 1; i < blocks; i ++) {
		StockPool[i]->Wheel = pwheel + BLOCK_SIZE * (i - 1);
